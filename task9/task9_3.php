<html>
	<head>
		...
		<body>
			...
			if(isset($_GET['maker'])){
				...
				foreach($cars as $item){
					if(strcmp($item['maker'],$maker)==0){
						$k = array_search($item, $cars);
						echo "<div class=\"card\">
								<div><img src=\"".$cars[$k]['image']."\" width=\"110px\" height=\"110px\"/></div>
								<div class=\"description\">
									<div class=\"title\">
										".$cars[$k]['maker']." ".$cars[$k]['model']."
									</div>
									<div class=\"price\">
										".$cars[$k]['price']."$
									</div>
			...
			<div class="menu">
			<a href="task9_3.php">Home</a>|<a href="task9_3.php?maker=Toyota">Toyota</a>|<a href="task9_3.php?maker=BMW">BMW</a>|<a href="task9_3.php?maker=Audi">Audi</a>|<a href="task9_3.php?maker=Lada">Lada</a></div>

			<div class="menu">
			<a href="task9_3.php?year=old">Old cars (More than 7 years)</a>|<a href="task9_3.php?price=expensive">Expensive cars (more than 20.000$)</a></div>
	</body>
</html>